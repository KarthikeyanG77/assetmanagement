...
// Fetch assets with status 'Service' and service centers for dropdowns
$assets = $pdo->query("SELECT asset_id, asset_name, r_no FROM asset WHERE status = 'Service' ORDER BY asset_name")->fetchAll();
                            ...
                            <select class="form-select" id="asset_id" name="asset_id" required>
                                ...
                                <?php foreach ($assets as $asset): ?>
                                    <option value="<?= htmlspecialchars($asset['asset_id'] ?? '') ?>">
                                        ...
                                        <?php if (!empty($asset['r_no'])): ?>
                                            (R.No: <?= htmlspecialchars($asset['r_no']) ?>)
                                        <?php endif; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
